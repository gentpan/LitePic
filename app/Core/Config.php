...
final class Config
{
    ...
    private static function candidateEnvKeys(): array
    {
        return [
            ...
            'REMOTE_STORAGE_USAGE', 'REMOTE_STORAGE_DRIVER',
            'S3_BUCKET', 'S3_REGION', 'S3_ENDPOINT',
            'S3_KEY', 'S3_SECRET', 'S3_PATH_PREFIX', 'S3_PUBLIC_BASE_URL',
            'REMOTE_WEBDAV_URL', 'REMOTE_WEBDAV_USERNAME', 'REMOTE_WEBDAV_PASSWORD',
            'REMOTE_WEBDAV_PATH_PREFIX', 'REMOTE_WEBDAV_PUBLIC_BASE_URL',
            'MANAGED_API_TOKENS_JSON',
            'CORS_ALLOWED_ORIGINS',
            'DEBUG',
            'TELEGRAM_ENABLED', 'TELEGRAM_BOT_TOKEN', 'TELEGRAM_WEBHOOK_SECRET',
            'TELEGRAM_ALLOWED_USER_IDS', 'TELEGRAM_DEFAULT_ALBUM_KEY',
        ];
    }
